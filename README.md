...
- 🎙️ **Transcripción Local en Tiempo Real:** Moonshine usa Tiny Streaming para inglés y Base para español. Solicita actualizaciones provisionales cada 0,5 segundos, agrupa automáticamente la cola si el equipo se retrasa y limita cada línea a seis segundos. El modo automático usa Whisper una vez para elegir el modelo; Whisper también permanece disponible como motor de compatibilidad.
- ⏳ **Preparación Inicial Completa:** la pantalla de arranque descarga y verifica Whisper, Moonshine inglés y Moonshine español, inicializa los tres modelos en memoria y conserva sus workers listos antes de habilitar la captura. Cambiar entre Auto, EN y ES no vuelve a descargar ni reconstruir los modelos durante la sesión.

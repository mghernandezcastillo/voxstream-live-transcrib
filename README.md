...
- ⏳ **Preparación Inicial Completa:** la pantalla de arranque descarga y verifica Whisper, Moonshine inglés y Moonshine español, inicializa en memoria el modelo Moonshine elegido o más probable y conserva su worker listo antes de habilitar la captura; las siguientes visitas reutilizan la caché del navegador.
